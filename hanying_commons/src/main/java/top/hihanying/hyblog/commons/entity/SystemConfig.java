package top.hihanying.hyblog.commons.entity;

import com.baomidou.mybatisplus.annotation.FieldStrategy;
import com.baomidou.mybatisplus.annotation.TableField;
import com.baomidou.mybatisplus.annotation.TableName;
import top.hihanying.hyblog.base.entity.SuperEntity;
import lombok.Data;
...
public class SystemConfig extends SuperEntity<SystemConfig> {
    ...
    /**
     * 七牛云存储图片服务器，域名前缀: http://images.hanyingit.cn
     */
    @TableField(updateStrategy = FieldStrategy.IGNORED)
    private String qiNiuPictureBaseUrl;

    /**
     * Minio服务器文件域名前缀： http://minio.hanyingit.cn
     */
    @TableField(updateStrategy = FieldStrategy.IGNORED)
