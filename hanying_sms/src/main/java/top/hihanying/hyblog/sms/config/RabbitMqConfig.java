package top.hihanying.hyblog.sms.config;
...
public class RabbitMqConfig {
    ...
    public static final String MOGU_BLOG = "hanying.blog";
    public static final String MOGU_EMAIL = "hanying.email";
    public static final String MOGU_SMS = "hanying.sms";
    public static final String EXCHANGE_DIRECT = "exchange.direct";
    public static final String ROUTING_KEY_BLOG = "hanying.blog";
    public static final String ROUTING_KEY_EMAIL = "hanying.email";
    public static final String ROUTING_KEY_SMS = "hanying.sms";
    ...
    /**
     * hanying.blog 队列绑定交换机，指定routingKey
     *
     * @param queue
     * @param exchange
     * @return
    ...
    /**
     * hanying.mail 队列绑定交换机，指定routingKey
     *
     * @param queue
     * @param exchange
     * @return
    ...
    /**
     * hanying.sms 队列绑定交换机，指定routingKey
     *
     * @param queue
     * @param exchange
     * @return
