...
import top.hihanying.hyblog.commons.fallback.SearchFeignFallback;
 ...
 */
@FeignClient(name = "hanying-search", configuration = FeignConfiguration.class, fallback = SearchFeignFallback.class)
