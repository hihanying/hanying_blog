package top.hihanying.hyblog.commons.feign;

import top.hihanying.hyblog.commons.config.feign.FeignConfiguration;
import top.hihanying.hyblog.commons.fallback.PictureFeignFallback;
 ...
 * @author 应寒
 */
@FeignClient(name = "hanying-picture", configuration = FeignConfiguration.class, fallback = PictureFeignFallback.class)
