...
import top.hihanying.hyblog.commons.feign.SearchFeignClient;
import top.hihanying.hyblog.sms.global.RedisConf;
import top.hihanying.hyblog.sms.global.SysConf;
...
public class BlogListener {
    ...
    @RabbitListener(queues = "hanying.blog")
...
//                    searchFeignClient.updateSolrIndexByUid(uid);
                ...
                case SysConf.DELETE: {
                    log.info("hanying-sms处理删除博客: uid:" + uid);
                    updateSearch(map);
