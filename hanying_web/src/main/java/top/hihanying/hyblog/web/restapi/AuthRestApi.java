...
import top.hihanying.hyblog.commons.entity.Link;
import top.hihanying.hyblog.commons.entity.SystemConfig;
import top.hihanying.hyblog.commons.entity.User;
import top.hihanying.hyblog.commons.feign.PictureFeignClient;
import top.hihanying.hyblog.utils.*;
import top.hihanying.hyblog.web.global.MessageConf;
import top.hihanying.hyblog.web.global.RedisConf;
import top.hihanying.hyblog.web.global.SQLConf;
import top.hihanying.hyblog.web.global.SysConf;
import top.hihanying.hyblog.xo.service.*;
import top.hihanying.hyblog.xo.utils.RabbitMqUtil;
import top.hihanying.hyblog.xo.utils.WebUtil;
import top.hihanying.hyblog.xo.vo.FeedbackVO;
import top.hihanying.hyblog.xo.vo.LinkVO;
import top.hihanying.hyblog.xo.vo.UserVO;
import top.hihanying.hyblog.base.enums.EGender;
import top.hihanying.hyblog.base.enums.ELinkStatus;
        ...
        switch (source) {
            case SysConf.GITHUB:
                authRequest = new AuthGithubRequest(AuthConfig.builder()
                        ...
                        .redirectUri(hanyingWebUrl + "/oauth/callback/github")
                        .build());
                break;
            case SysConf.GITEE:
                authRequest = new AuthGiteeRequest(AuthConfig.builder()
                        ...
                        .redirectUri(hanyingWebUrl + "/oauth/callback/gitee")
                        .build());
                break;
            case SysConf.QQ:
                authRequest = new AuthQqRequest(AuthConfig.builder()
                        ...
                        .redirectUri(hanyingWebUrl + "/oauth/callback/qq")
                        .build());
                break;
            default:
                break;
